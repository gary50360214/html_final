<?php
	...
	$article = mysqli_fetch_assoc(mysqli_query($_SESSION['link'], $sql));
?>
	...
	<body>
				...
				<div class="col-12 col-sm-12 px-0">
					<form id="article">
						...
						<div class="form-group mb-5">
							...
							<input type="hidden" id='title_img_url' value="<?php echo $article['title_img_url']; ?>">
							<div id="show_image">
								<img src="../<?php echo $article['title_img_url']; ?>" alt="文章圖片">
							</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="title" placeholder="請輸入標題" value="<?php echo $article['title']; ?>" required>
						</div>
						
						<div class="form-group">
							<label for="tag">分類標籤</label>
							<input type="text" class="form-control" id="tag" placeholder="請輸入分類標籤" value="<?php echo $article['tag']; ?>" required>
						</div>
						<div class="form-group">
							<label for="content">文章內容</label>
							<textarea class="form-control" id="content" rows="10" placeholder="請輸入文章內容" required><?php echo $article['content']; ?></textarea>
							<script>
						...
						<div class="form-grop mb-5">
							<div class="form-check form-check-inline">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="is_released" id="inlineRadio1" value="1" <?php echo ($article['is_released'] == 1)?"checked":""; ?>>發布
								</label>
							</div>
							<div class="form-check form-check-inline">
								<label class="form-check-label">
									<input class="form-check-input" type="radio" name="is_released" id="inlineRadio2" value="0" <?php echo ($article['is_released'] == 0)?"checked":""; ?>>不發布
								</label>
							</div>
						</div>
		...
		<script>
			$(document).ready(function(){
				//看此篇文章有沒有圖片 沒有的的話就將刪除鈕隱藏
                if($("#title_img_url").val() == 'files/images/no-image.png'){
                    $("#del_image").hide();
                }
