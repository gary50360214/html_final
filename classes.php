...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" onclick="location.href='./search.php'">Search</button>
    </form>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="card" id = "teacher_info">
                    <img class="card-img-top" src="./images/classes_1.jpg">
                    <div class="card-body">
                        ...
                        <p class = "info">　　
                                現職：逢甲大學微積分教學中心 副教授<br>　　
                                學歷：國立清華大學數學系　博士<br>　　
                                經歷：<br>　　
                                逢甲大學微積分教學中心　助理教授<br>　　
                                國立交通大學應用數學系　博士後研究人員<br>　　
                                科技部與逢甲大學等教學研究計畫主持人<br>　　
                                高中磨課師計畫審查委員<br>　　
                                高中磨課師教學影片審查委員<br>　　
                                簡述：<br>　　
                                專長為<br>　　
                                數學分析Mathematical Analysis<br>　　
                                泛函分析Functional Analysis<br>　　
                                矩陣分析Matrix Analysis<br>　　
                                數位學習E-Learning<br>　　
                                翻轉學習Flipped Learning
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-md-6"><?=$data['content']?>
                <b>課程簡介</b>
