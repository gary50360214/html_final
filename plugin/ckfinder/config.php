...
$config['authentication'] = function () {
    return true;//true 開啟功能
};

/*============================ License Key ============================================*/
// http://docs.cksource.com/ckfinder3-php/configuration.html#configuration_options_licenseKey

//$config['licenseName'] = '192.168.0.16';
//$config['licenseKey']  = '72726NSUTTWAMU5IXMRR5OK2LQOKG';
//http://www.phamgiang.pro/apps/ckfinderKey /*註冊機 已使用garyl62327@gmail.com kk851122 這支FB分享過 案讚過 */
$config['licenseName'] = 'localhost';
$config['licenseKey']  = 'BTPTR1WCVC84YW3FA2C64A23KHLNQ';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/blog/files/ckfinder_upload/',
